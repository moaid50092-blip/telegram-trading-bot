    ...
    def create_stop_loss_order(self, symbol: str, amount: float, stop_price: float) -> Optional[str]:  
        ...
        try:  
            ...
            order = self.exchange.create_order(  
                ...
                price=formatted_stop_price * 0.99,  
                params=params  
            )  
            ...
            for symbol, analysis in ranked_symbols:  
                ...
                if existing_trade:  
                    if analysis.score - existing_trade.score >= TradingConfig.PROGRESSIVE_ENTRY_BOOST_THRESHOLD:  
                        boost_usdt = self.current_capital * self.config.MAX_CAPITAL_PER_TRADE * (1 - TradingConfig.PROGRESSIVE_ENTRY_INITIAL_PERCENT)  
                ...
                entry_usdt = self.current_capital * self.config.MAX_CAPITAL_PER_TRADE * TradingConfig.PROGRESSIVE_ENTRY_INITIAL_PERCENT * size_multiplier  
                ...
                trade_id = f"T{int(time.time())}_{symbol.replace('/', '_')}"  
